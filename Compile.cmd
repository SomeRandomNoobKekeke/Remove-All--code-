...
cd %CompilerDir%
dotnet build .\Compiler.sln -c Release /clp:ErrorsOnly -p WarningLevel=0 -maxcpucount:2 -p:ModAssemblyName=%ModAssemblyName% -p:ModRootNamespace=%ModRootNamespace% -p:SourceModDir=%SourceModDir% -p:ModDeployDir=%ModDeployDir%
